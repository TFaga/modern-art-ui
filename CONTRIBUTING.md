# Contributing to Modern Art UI

♥ [Modern Art UI](https://github.com/TFaga/modern-art-ui) and want to get involved?
...
**[File a bug report](https://github.com/TFaga/modern-art-ui/issues/)**
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/modern-art-ui.git
   # Navigate to the newly cloned directory
   cd html5-boilerplate
   # Assigns the original repo to a remote called "upstream"
   git remote add upstream https://github.com/tfaga/modern-art-ui.git
   ```
